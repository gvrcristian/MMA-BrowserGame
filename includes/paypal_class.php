...
class paypal_class {
	...
	public function submit_paypal_post() {
		...
		echo "<script type=\"text/javascript\">document.forms['paypal_form'].submit();</script>\n";
		...
		echo "<input type=\"submit\" class=\"btn btn-primary\" value=\"Click here if do not redirect automatically.\"></center>\n";
